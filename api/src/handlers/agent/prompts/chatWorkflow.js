...
- You must provide specific data keys, values, or statistics from the ANALYSIS OUTPUTS in the synthesis.
- DO NOT repeat previous CHAT MESSAGES, ONLY synthesize content in the ANALYSIS OUTPUTS.
- **DO NOT** include a follow up question at the end of your synthesis.
- Aim to only use 1 sentence if possible, avoid adding unnecessary complexity, repitition, redundancy, or follow up questions.
...
- Provide your output in the format as specified below.
- DO NOT include more than one question seperated by 'or'; **ONLY PROVIDE ONE**.
...
---Examples---
Example 1:
User Messages: "How high did the UAV go?"

Synthesized Response: "The UAV reached a maximum altitude of 1200 meters during the flight."

Output:
Would you like to know the duration the UAV stayed at its maximum altitude?
